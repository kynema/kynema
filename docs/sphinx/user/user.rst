...
These examples are meant to be linked against an Kynema-FMB installation and can serve as the basis for specifiying your own problem using our interfaces.
