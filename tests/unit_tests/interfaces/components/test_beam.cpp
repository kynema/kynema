...
TEST(BeamComponentTest, Quadrature_TwoSections_NoRefinement) {
    auto model = kynema::Model();
    auto beam_input = kynema::interfaces::components::BeamInput{};
...
TEST(BeamComponentTest, Quadrature_ThreeSections_NoRefinement) {
    auto model = kynema::Model();
    auto beam_input = kynema::interfaces::components::BeamInput{};
...
TEST(BeamComponentTest, Quadrature_FourSections_NoRefinement) {
    auto model = kynema::Model();
    auto beam_input = kynema::interfaces::components::BeamInput{};
...
TEST(BeamComponentTest, Quadrature_FourSections_NoRefinement_Length2) {
    auto model = kynema::Model();
    auto beam_input = kynema::interfaces::components::BeamInput{};
...
TEST(BeamComponentTest, Quadrature_ElevenSections_NoRefinement) {
    auto model = kynema::Model();
    auto beam_input = kynema::interfaces::components::BeamInput{};
...
TEST(BeamComponentTest, Quadrature_TwoSections_OneRefinement) {
    auto model = kynema::Model();
    auto beam_input = kynema::interfaces::components::BeamInput{};
...
TEST(BeamComponentTest, Quadrature_TwoSections_TwoRefinements) {
    auto model = kynema::Model();
    auto beam_input = kynema::interfaces::components::BeamInput{};
...
TEST(BeamComponentTest, Quadrature_ThreeSections_OneRefinement) {
    auto model = kynema::Model();
    auto beam_input = kynema::interfaces::components::BeamInput{};
...
TEST(BeamComponentTest, Quadrature_FourSections_TwoRefinement) {
    auto model = kynema::Model();
    auto beam_input = kynema::interfaces::components::BeamInput{};
...
TEST(BeamComponentTest, Quadrature_ElevenSections_OneRefinement) {
    auto model = kynema::Model();
    auto beam_input = kynema::interfaces::components::BeamInput{};
